...
class VideoListActivity : AppCompatActivity(), VideoListAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        context = this
        setupToolbar()
        val videoList = generateVideoDataSource()
        val adapter = VideoListAdapter(context, videoList)
    ...
    private fun generateVideoDataSource(): List<Video> {
      ...
      val video1 = Video(
          ...
          "Sample Video 1",
          "This is a first sample video for testing",
      )
        val video2 = Video(
            2,
            "https://image.shutterstock.com/image-vector/cool-flat-vector-illustration-on-600w-1382240516.jpg",
            "https://jsoncompare.org/LearningContainer/SampleFiles/Video/MP4/Sample-MP4-Video-File-Download.mp4",
            "Sample Video 2",
            "This is a second sample video for testing"
        )
        val video3 = Video(
            3,
            "https://image.shutterstock.com/image-vector/summer-fair-festival-horizontal-header-600w-1401875312.jpg",
            "https://filesamples.com/samples/video/mp4/sample_1280x720_surfing_with_audio.mp4",
            "Sample Video 3",
            "This is a third sample video for testing"
        )
        val video4 = Video(
            4,
            "https://image.shutterstock.com/image-vector/cool-retro-movie-projector-vector-600w-257123578.jpg",
    ...
    override fun onPause() {
        super.onPause()
        rvVideoList.stopInlineVideoPlaying()
    }

    override fun onRestart() {
        super.onRestart()
        rvVideoList.switchPlayerView()
    }

    override fun onItemClick(video: Video) {
        val intent = Intent(context, VideoPlayerActivity::class.java).apply {
            putExtra(MediaController.VIDEO_BUNDLE_KEY, video)
        }
        val options = ActivityOptionsCompat.makeSceneTransitionAnimation(
            this,
            rvVideoList.getVideoView() as View,
